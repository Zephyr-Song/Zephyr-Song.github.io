...
(function() {
  ...
  function init() {
    ...
    var styleCSS = [
      ...
      '#gmp-body{background:rgba(18,18,18,0.92);backdrop-filter:blur(8px);padding:12px}',
    ...
    hint.style.cssText = 'position:fixed;bottom:160px;right:10px;background:rgba(29,185,84,0.9);color:#fff;padding:8px 12px;border-radius:6px;font-size:12px;z-index:10005;pointer-events:none;animation:gmp-hint-fade 4s ease forwards';
