...
`
  ...
  var css = [
    /* 右下角固定定位 */
    '#gmeek-player{position:fixed;left:24px;top:120px;z-index:10004;font-family:Arial,Helvetica,sans-serif;}',
    ...
    /* 移动端响应 */
    '@media(max-width:480px){#gmeek-player{left:8px;top:120px;}#gmp-body{width:calc(100vw - 52px);}}',
  ].join('');
